...
$usuarioMod=$_GET['id_user'];
    // conecta a mariaDB
$conn = new mysqli($serverDB, $userDB, $passwordDB, $nombreDB);

// obtener datos del usuario
$sql = "SELECT id_user, email, calendar_token, user_created, user_lastlogin FROM users WHERE id_user='$usuarioMod'";
...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <form action="perfil_actualizar.php?admin=yes&id_user=<?php echo $usuario['id_user']; ?>" method="POST">
                <!-- Campo para el Email -->
                <div class="mb-3">
